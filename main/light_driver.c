...
void light_driver_set_color_xy(uint16_t color_current_x,
                               uint16_t color_current_y) {
  ...
  ESP_ERROR_CHECK(led_strip_set_pixel(s_led_strip, 0, s_red * ratio,
                                      s_green * ratio, s_blue * ratio));
...
void light_driver_set_color_RGB(uint8_t red, uint8_t green, uint8_t blue) {
  ...
  s_green = green;
  s_blue = blue;
  ESP_ERROR_CHECK(led_strip_set_pixel(s_led_strip, 0, red * ratio,
